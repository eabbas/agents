        ...
        <div class="col-md-12">
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    ...
                    <form class="ls_form" role="form" action="{{ route('product.update', ['product' => $reqData['id']]) }}"
                        method="post">
                        {!! csrf_field() !!}
                        ...
                        <div class="col-lg-6 col-sm-12">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label>توضیحات</label>
                                        <textarea name="description" cols="80" rows="10" placeholder="توضیحات را وارد کنید">{{ $ready ? $reqData['description'] : '' }} </textarea>
                                        @error('description')
                                            <div class="invalid-feedback">
                                                <small style="color: red">{{ $message }}</small>
                                            </div>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input name="price" class="form-control"
                                            value="{{ $ready ? $reqData['price'] : '' }}" placeholder="قیمت را وارد کنید">
                                        @error('price')
                                            <div class="invalid-feedback">
                                                <small style="color: red">{{ $message }}</small>
                                            </div>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <select id="select-state" name="kits[]" multiple class="demo-default"
                                            ...
                                            @foreach ($kits as $kit)
                                                <option {{ $ready && in_array($kit['id'], $keys) ? 'selected' : '' }}
                                                    value="{{ $kit['id'] }}">{{ $kit['title'] }}</option>
                                            @endforeach
                                        </select>
                                    </div>
                                </div>
