        ...
        <div class="col-md-12">
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    ...
                    <form class="ls_form" role="form" action="{{ route('agent.store') }}" method="post">
                        {!! csrf_field() !!}
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input name="family" class="form-control" value="{{ old('family') }}"
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="email" name="email" class="form-control"
                                            value="{{ old('email') }}" placeholder="ایمیل نماینده">
                                        @error('email')
                                            <div class="invalid-feedback">
                                                <small style="color: red">{{ $message }}</small>
                                            </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-3">
                                    <div class="form-group">
                                        ...
                                        <input name="sellpercent01" class="form-control" placeholder="۰ تا ۱۰۰">
                                    </div>
                                </div>
                                <div class="col-md-3">
                                    <div class="form-group">
                                        <label>درصد کیت </label>
                                        <input name="sellpercent02" class="form-control" placeholder="۰ تا ۱۰۰">
                                    </div>
                                </div>
                                <div class="col-md-3">
                                    <div class="form-group">
                                        <label>درصد ارتقا</label>
                                        <input name="sellpercent03" class="form-control" placeholder="۰ تا ۱۰۰">
                                    </div>
                                </div>
                                <div class="col-md-3">
                                    <div class="form-group">
                                        <label>درصد تمدید</label>
                                        <input name="sellpercent04" class="form-control" placeholder="۰ تا ۱۰۰">
                                    </div>
                                </div>
                            </div>
                        </div>
